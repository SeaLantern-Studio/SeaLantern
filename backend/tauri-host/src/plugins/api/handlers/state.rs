...
pub(super) type ApiCallHandler =
    dyn Fn(&str, &str, &str, Vec<JsonValue>) -> Result<JsonValue, String> + Send + Sync;
...
pub(super) type ContextMenuHandler =
    dyn Fn(&str, &str, &str, &str) -> Result<(), String> + Send + Sync;
pub(super) type SidebarEventHandler =
    dyn Fn(&str, &str, &str, &str) -> Result<(), String> + Send + Sync;
pub(super) type PermissionLogHandler =
    dyn Fn(&str, &str, &str, &str, u64) -> Result<(), String> + Send + Sync;
...
pub(super) type I18nEventHandler =
    dyn Fn(&str, &str, &str, &str) -> Result<(), String> + Send + Sync;
...
pub(super) static SIDEBAR_EVENT_HANDLER: RwLock<Option<Arc<SidebarEventHandler>>> =
    RwLock::new(None);
pub(super) static PERMISSION_LOG_HANDLER: RwLock<Option<Arc<PermissionLogHandler>>> =
    RwLock::new(None);
pub(super) static COMPONENT_EVENT_HANDLER: RwLock<Option<Arc<ComponentEventHandler>>> =
    RwLock::new(None);
