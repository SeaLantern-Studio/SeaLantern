...
#[cfg(target_os = "windows")]
use server_local_setup::build_windows_bat_command_text as build_shared_windows_bat_command_text;
#[cfg(target_os = "windows")]
use server_local_setup::build_windows_bat_command_text_without_java as build_shared_windows_bat_command_text_without_java;
#[cfg(target_os = "windows")]
...
mod tests {
    ...
    use server_local_setup::prepend_path_entry;
    #[cfg(target_os = "windows")]
    use server_local_setup::{build_windows_java_env_prefix, ManagedConsoleEncoding};
    use std::process::Command;
