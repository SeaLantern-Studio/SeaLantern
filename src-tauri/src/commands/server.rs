...
#[tauri::command]
pub fn resolve_starter_download_url(core_type: String, mc_version: String) -> Result<String, String> {
    let core_type_key = crate::services::server_installer::CoreType::normalize_to_api_core_key(&core_type)
