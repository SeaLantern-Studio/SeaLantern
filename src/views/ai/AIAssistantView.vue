        ...
        <div class="quick-commands">
          ...
          <div class="quick-command-list">
            <button
              ...
              :key="cmd.text"
              @click="naturalLanguageInput = cmd.text; generateCommand()"
            >
              {{ cmd.label }}
            </button>
          </div>
      ...
      <div class="section-card">
        ...
        <div v-else class="config-textarea">
          <textarea
            ...
            rows="15"
          ></textarea>
          <button class="analyze-btn" @click="analyzeConfig" :disabled="analyzingConfig || !configInput.trim()">
            <LoadingIcon v-if="analyzingConfig" class="spinning" />
            <SettingsIcon v-else />
  ...
  ') }}</pre>
    ...
    <div v-if="activeTab === 'translate'" class="tab-content">
      <div class="section-card">
        ...
        <button class="translate-btn" @click="translateText" :disabled="translating || !translateInput.trim()">
