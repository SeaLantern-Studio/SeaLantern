...
import ConfigEditorPane from "@next-src/components/server-instance/config/ConfigEditorPane.vue";
import ConfigFileList from "@next-src/components/server-instance/config/ConfigFileList.vue";
import ConfigPreviewPane from "@next-src/components/server-instance/config/ConfigPreviewPane.vue";
