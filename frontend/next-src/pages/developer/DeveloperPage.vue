...
import DeveloperDangerSection from "@next-src/components/developer/DeveloperDangerSection.vue";
import DeveloperLogsSection from "@next-src/components/developer/DeveloperLogsSection.vue";
import DeveloperOverviewSection from "@next-src/components/developer/DeveloperOverviewSection.vue";
import DeveloperToolsSection from "@next-src/components/developer/DeveloperToolsSection.vue";
...
import WorkbenchSectionHeader from "@next-src/components/workbench/WorkbenchSectionHeader.vue";
import WorkbenchSplitView from "@next-src/components/workbench/WorkbenchSplitView.vue";
