...
import ColorThemeCard from "@next-src/components/paint/ColorThemeCard.vue";
import ErrorBanner from "@next-src/components/paint/ErrorBanner.vue";
import ImportSettingsModal from "@next-src/components/paint/ImportSettingsModal.vue";
import ResetConfirmModal from "@next-src/components/paint/ResetConfirmModal.vue";
import SettingsActions from "@next-src/components/paint/SettingsActions.vue";
import TextCustomizationCard from "@next-src/components/paint/TextCustomizationCard.vue";
import ConsoleSettingsCard from "@next-src/components/settings/ConsoleSettingsCard.vue";
