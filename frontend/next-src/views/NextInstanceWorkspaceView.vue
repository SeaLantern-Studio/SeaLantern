...
import type { NextInstanceSection } from "@next-src/contracts/instance";
import type { NextShellNavItem } from "@next-src/contracts/shell";
import { useNextShellNavigationTransition } from "@next-src/composables/useNextShellNavigationTransition";
import { useProvideNextInstanceWorkspace } from "@next-src/composables/useNextInstanceWorkspace";
import NextWorkbenchLayout from "@next-src/layout/NextWorkbenchLayout.vue";
