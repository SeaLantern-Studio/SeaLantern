...
import ExtensionEntryList from "@src/components/server-instance/extensions/ExtensionEntryList.vue";
import ExtensionsSummaryBar from "@src/components/server-instance/extensions/ExtensionsSummaryBar.vue";
