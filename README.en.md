...
If you want to understand the repository structure, frontend/backend boundaries, and main modules, see [Project Structure](https://docs.ideaflash.cn/en/dev/STRUCTURE), also [Front Docs](frontend/README.md) and [Backend Docs](backend/README.md) with your translator.
