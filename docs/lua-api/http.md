...
| ------------------------------------ | ---------------------------------------------------------- | ----------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| `sl.http.get(url, options?)`         | `url: string`，`options?: table`                           | `table \| nil, string?` | 发起 `GET` 请求，请求成功时返回响应表，失败时返回 `nil, error` | [`execute_http_request()`](../../backend/tauri-host/src/plugins/runtime/http/mod.rs:73) |
| `sl.http.post(url, body?, options?)` | `url: string`，`body?: string \| table`，`options?: table` | `table \| nil, string?` | 发起 `POST` 请求，`body` 为 Lua 表时会自动序列化为 JSON        | [`execute_http_request()`](../../backend/tauri-host/src/plugins/runtime/http/mod.rs:73) |
| `sl.http.put(url, body?, options?)`  | `url: string`，`body?: string \| table`，`options?: table` | `table \| nil, string?` | 发起 `PUT` 请求，`body` 为 Lua 表时会自动序列化为 JSON         | [`execute_http_request()`](../../backend/tauri-host/src/plugins/runtime/http/mod.rs:73) |
| `sl.http.delete(url, options?)`      | `url: string`，`options?: table`                           | `table \| nil, string?` | 发起 `DELETE` 请求                                             | [`execute_http_request()`](../../backend/tauri-host/src/plugins/runtime/http/mod.rs:73) |
...
当 `body` 是 Lua table 时，会在 [`lua_body_to_string()`](../../backend/tauri-host/src/plugins/runtime/http/request.rs:107) 中自动序列化成 JSON，并在未显式提供 `Content-Type` 时由 [`with_json_content_type()`](../../backend/tauri-host/src/plugins/runtime/http/request.rs:120) 自动补上 `application/json`。
